if( NOT  SIXTRACKL_CMAKE_SETUP_CUDA_FINISHED   )
    ...
    if( SIXTRACKL_ENABLE_CUDA AND SIXTRACKL_ENABLED_LANGS MATCHES "CUDA" )
        set( SIXTRACKL_CUDA_INCLUDE_DIRS ${SIXTRACKL_CUDA_INCLUDE_DIRS} ${CMAKE_CUDA_TOOLKIT_INCLUDE_DIRECTORIES} )
        message( STATUS "include dirs: ${SIXTRACKL_CUDA_INCLUDE_DIRS}" )
    endif()
